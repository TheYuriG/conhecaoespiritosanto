// Exporta uma ilustração de um homem no computador com expressão surpresa. Permite modificar cores primárias e secundárias da ilustração, além de classes do SVG.
export function DeveloperIllustrationSvg(
  { primaryColor, secondaryColor, classes }: {
    primaryColor: string;
  ...
  return (
    ...
    >
      <defs>
        <style>
          {`.cls-1,.cls-3{
                fill:none;stroke:${primaryColor};stroke-linecap:round;stroke-linejoin:round;
            }
