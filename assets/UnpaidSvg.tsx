// Exporta um componente de um SVG de monetização opcional. Permite customização de classes e a cor do contorno. Extraído de TablerIcons.
export function UnpaidSvg(
